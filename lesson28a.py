...
# My SVC predicts: [ 1. 1. 0. 0. 0. 1. 0. 1. 0. 1.] 
# For these 10 labels: [ 1. 1. 0. 0. 0. 1. 0. 1. 0. 1.] 
# 0.00109 Seconds to predict 10 labels with SVC

# Using spatial binning of: 48 and 24 histogram bins 
# Feature vector length: 6984 
# 6.55 Seconds to train SVC... 
# Test Accuracy of SVC = 0.9833 
# My SVC predicts: [ 1. 0. 0. 0. 1. 0. 1. 1. 0. 1.] 
# For these 10 labels: [ 1. 0. 0. 0. 1. 0. 1. 1. 0. 1.] 
